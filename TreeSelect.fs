...
type TreeSelect() =
    ...
    member x.FilterTreeNode with set (v: bool) = x.Attribute "filterTreeNode" v
    ...
    member x.SearchPlaceholder with set (v: string) = x.Attribute "searchPlaceholder" v 
    member x.SearchValue with set (v: string) = x.Attribute "searchValue" v
    member x.TreeIcon with set (v: bool) = x.Attribute "treeIcon" v
    member x.ShowCheckedStrategy with set (v: obj) = x.Attribute "showCheckedStrategy" v 
    ...
    member x.TreeExpandedKeys with set (v: string array) = x.Attribute "treeExpandedKeys" v
    member x.TreeNodeFilterProp with set (v: string) = x.Attribute "treeNodeFilterProp" v 
    member x.TreeNodeLabelProp with set (v: string) = x.Attribute "treeNodeLabelProp" v
