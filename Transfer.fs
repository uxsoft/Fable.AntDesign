...
type AntTransfer() =
    ...
    member x.DataSource
        with set (v: TransferData array) = x.Attribute "DataSource" v
    member x.Disabled
    ...
    member x.ListStyle
        with set (v: obj -> obj) = x.Attribute "ListStyle" v
    member x.Locale
        with set (v: TransferLocale) = x.Attribute "Locale" v
    member x.Operations
        with set (v: string array) = x.Attribute "Operations" v
    member x.Render
        with set (v: TransferData -> ReactElement) = x.Attribute "Render" v
    member x.ShowSearch
        with set (v: bool) = x.Attribute "ShowSearch" v
    member x.ShowSelectAll
        with set (v: bool) = x.Attribute "ShowSelectAll" v
    member x.TargetKeys
        with set (v: string array) = x.Attribute "TargetKeys" v
    member x.Titles
        with set (v: ReactElement array) = x.Attribute "Titles" v

    member x.OnChange
        with set (v: string array -> TransferDirection -> string array -> unit) =
            let uncurried = System.Func<string array, TransferDirection, string array, unit> v
            x.Attribute "OnChange" uncurried

    member x.OnScroll
        with set (v: TransferDirection -> Event) = x.Attribute "OnScroll" v

    member x.OnSearch
        with set (v: TransferDirection -> string -> unit) =
    ...
    member x.OperationsStyle
        with set (css: Props.CSSProp list) =
