...
type AntSelect() =
    ...
    member x.defaultMultiValue (v: string array) = x.attribute "defaultValue" v
    ...
    member x.multiValue (v: string array) = x.attribute "value" v
    member x.value (v: string) = x.attribute "value" v
    ...
    member x.onMultiChange (v: string array -> unit) = x.attribute "onChange" v
