...
type TableColumnBuilder<'T>() =
    ...
    [<CustomOperation("filterDropdownVisible")>] member _.filterDropdownVisible (x: DSLElement) = x.attr "filterDropdownVisible" true
    [<CustomOperation("filtered")>] member _.filtered (x: DSLElement) = x.attr "filtered" true
    ...
    [<CustomOperation("filterMultiple")>] member _.filterMultiple (x: DSLElement) = x.attr "filterMultiple" true
    [<CustomOperation("filters")>] member _.filters (x: DSLElement, v: obj array) = x.attr "filters" v
    [<CustomOperation("isFixed")>] member _.isFixed (x: DSLElement) = x.attr "fixed" true
    ...
    [<CustomOperation("sorter")>] member _.sorter (x: DSLElement) = x.attr "sorter" true
    ...
    [<CustomOperation("showSorterTooltip")>] member _.showSorterTooltip (x: DSLElement) = x.attr "showSorterTooltip" true
...
type TableBuilder<'T>() =
    ...
    [<CustomOperation("showHeader")>] member _.showHeader (x: DSLElement) = x.attr "showHeader" true
