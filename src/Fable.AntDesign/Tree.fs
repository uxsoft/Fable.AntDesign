...
type TreeBase<'T>() =
    ...
    [<CustomOperation("blockNode")>] member _.blockNode (x: DSLElement, v: bool) = x.attr "blockNode" v
    ...
    [<CustomOperation("checkStrictly")>] member _.checkStrictly (x: DSLElement, v: bool) = x.attr "checkStrictly" v
    [<CustomOperation("defaultCheckedKeys")>] member _.defaultCheckedKeys (x: DSLElement, v: string array) = x.attr "defaultCheckedKeys" v
    [<CustomOperation("defaultExpandAll")>] member _.defaultExpandAll (x: DSLElement, v: bool) = x.attr "defaultExpandAll" v
    ...
    [<CustomOperation("defaultExpandParent")>] member _.defaultExpandParent (x: DSLElement, v: bool) = x.attr "defaultExpandParent" v
    ...
    [<CustomOperation("draggable")>] member _.draggable (x: DSLElement, v: bool) = x.attr "draggable" v
    ...
    [<CustomOperation("showIcon")>] member _.showIcon (x: DSLElement, v: bool) = x.attr "showIcon" v
    [<CustomOperation("showLine")>] member _.showLine (x: DSLElement, v: bool) = x.attr "showLine" v
