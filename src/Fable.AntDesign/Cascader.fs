module Fable.AntDesign.Cascader
...
type CascaderBuilder() =
    ...
    [<CustomOperation("changeOnSelect")>] member _.changeOnSelect (x: DSLElement, v: bool) = x.attr "changeOnSelect" v
    ...
    [<CustomOperation("popupVisible")>] member _.popupVisible (x: DSLElement, v: bool) = x.attr "popupVisible" v
