...
type TransferBuilder() =
    ...
    [<CustomOperation("oneWay")>] member _.oneWay (x: DSLElement, v: bool) = x.attr "oneWay" v
    ...
    [<CustomOperation("pagination")>] member _.pagination (x: DSLElement, v: bool) = x.attr "pagination" v
    ...
    [<CustomOperation("showSelectAll")>] member _.showSelectAll (x: DSLElement, v: bool) = x.attr "showSelectAll" v
