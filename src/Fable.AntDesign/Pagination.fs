module Fable.AntDesign.Pagination
...
type PaginationBuilder() =
    ...
    [<CustomOperation("hideOnSinglePage")>] member _.hideOnSinglePage (x: DSLElement, v: bool) = x.attr "hideOnSinglePage" v
    ...
    [<CustomOperation("showQuickJumper")>] member _.showQuickJumper (x: DSLElement, v: bool) = x.attr "showQuickJumper" v
    [<CustomOperation("showSizeChanger")>] member _.showSizeChanger (x: DSLElement, v: bool) = x.attr "showSizeChanger" v
    [<CustomOperation("showTitle")>] member _.showTitle (x: DSLElement, v: bool) = x.attr "showTitle" v
    [<CustomOperation("showTotal")>] member _.showTotal (x: DSLElement, v: Func<int, int * int, ReactElement>) = x.attr "showTotal" v
    [<CustomOperation("simple")>] member _.simple (x: DSLElement, v: bool) = x.attr "simple" v
