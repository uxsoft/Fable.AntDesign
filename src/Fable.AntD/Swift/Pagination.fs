...
type AntPagination() =
    ...
    member x.hideOnSinglePage (?v: bool) = x.attribute "hideOnSinglePage" (Option.defaultValue true v)
    ...
    member x.showQuickJumper (?v: bool) = x.attribute "showQuickJumper" (Option.defaultValue true v)
    member x.showSizeChanger (?v: bool) = x.attribute "showSizeChanger" (Option.defaultValue true v)
    ...
    member x.simple (?v: bool) = x.attribute "simple" (Option.defaultValue true v)
