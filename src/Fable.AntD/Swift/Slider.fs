...
type AntSlider() =
    inherit AntElement<AntSlider>(ofImport "Slider" "antd")
    ...
    member x.defaultValues (v: float array) = x.attribute "defaultValue" v
    ...
    member x.values (v: float array) = x.attribute "value" v
