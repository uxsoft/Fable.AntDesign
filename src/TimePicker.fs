...
type AntTimePicker() =
    ...
    member x.hideDisabledOptions (?v: bool) = x.attribute "hideDisabledOptions" (Option.defaultValue true v)
    member x.hourStep (v: int) = x.attribute "hourStep" v
    member x.inputReadOnly (?v: bool) = x.attribute "inputReadOnly" (Option.defaultValue true v)
    ...
    member x.use12Hours (?v: bool) = x.attribute "use12Hours" (Option.defaultValue true v)
...
type AntTimeRagePicker() =
    ...
    member x.showTime (?v: bool) = x.attribute "showTime" (Option.defaultValue true v)
    ...
    member x.order (?v: bool) = x.attribute "order" (Option.defaultValue true v)